...
Provider-specific built-in subagents can work differently. In Copilot harness sessions, Rubber Duck is a read-only critic that Copilot can invoke automatically or that you can request directly.
...
Hold Alt and select the in-transcript subagent pill.
Focus the in-transcript subagent pill and press Alt+Enter.
Hold Alt and select the subagent in the Chats dropdown.
...
Related resources
Agents overview - Learn about the different types of agents in VS Code
Custom agents - Create your own AI agents
Agent sessions - Create and organize agent sessions
Cache Explorer - See how context isolation affects prompt cache hit rates
9/2/2026
Support
Privacy
Manage Cookies
