...
## Get started (시작하기)
- Agents Quickstart (에이전트 퀵스타트)
	- https://code.visualstudio.com/docs/agents/quickstart
- Agents Tutorial (에이전트 튜토리얼)
...
- Sessions & Handoff (세션 및 핸드오프)
	- https://code.visualstudio.com/docs/agents/concepts/sessions
- Agent Host Architecture (에이전트 호스트 아키텍처)
...
## Customize agents (에이전트 커스터마이징)
- Create and Manage (생성 및 관리)
...
- Inline & Quick Chat (인라인 및 빠른 채팅)
	- https://code.visualstudio.com/docs/chat/inline-chat
- Add Prompt Context (프롬프트 컨텍스트 추가)
